...
<section class="content-header">
  ...
  <li><a href="dashboard.php"><strong><i class="fa fa-dashboard"></i> Home</strong></a></li>
        <li class="active"><strong>Incident Register</strong></li>
		 ...
		 <li class="active"><strong>Incident List</strong></li>
</ol>
</section>
<br />
  ...
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="main_bod">
    <tbody>
      <tr align="center" class="head_font" background="images\1by25.jpg">
        <td width="21%"><b>Sl. No.</b></td>
        <td width="59%" height="40"><strong>Incident Type</strong></td>
        <td width="20%" height="40"><strong>Options</strong></td>
      </tr>
      <tr align="center" >
      ...
      <?php
		  ...
		  $fsql = "select * from incident_master where im_status = '1' order by im_type asc";
		  $frec = q($fsql);
		  $i = 1;
		  while($fres = f($frec))
		  {
      ...
      <tr align="center" <?php echo $col;?>>
        ...
        <td><table width="107%" height="43" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="36%" height="32" align="center"><a href="incident_register.php?Edit=<?php echo $fres['im_id'];?>">
              ...
              <!--<td width="32%" align="center"><a href="#" onclick="delet('incident_list.php?Del=<?php //echo $fres['im_id'];?>')" >
