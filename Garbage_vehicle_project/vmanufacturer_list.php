<?php 
$page_name = "Vehicle Manufacturer List";
...
<section class="content-header">
  ...
  <li><a href="dashboard.php"><strong><i class="fa fa-dashboard"></i> Home</strong></a></li>
        <li class="active"><strong>Vehicle Details Register</strong></li>
		 ...
		 <li class="active"><strong>Manufacturer List</strong></li>
</ol>
</section>
<br>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="main_bod">
  ...
  <tbody>
    <tr align="center" class="head_font" background="images\1by25.jpg">
      ...
      <td width="37%" height="40"><b>Manufacturer</b></td>
	...
	<?php
	  $fsql = "select * from vehicle_manufacturer_master where vmm_status > '0' order by vmm_name asc" ;
	  $frec = q($fsql);
	  $i = 1;
	  while($fres = f($frec))
	  {
    ...
    <tr align="center" <?php echo $col;?>>
      ...
      <td><?php echo $fres['vmm_name'];?></td>
      <td><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
		  	<a href="vmanufacturer_register.php?Edit=<?php echo @$fres['vmm_id'];?>">
