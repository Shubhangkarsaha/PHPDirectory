...
<section class="content-header">
  ...
  <li><a href="dashboard.php"><strong><i class="fa fa-dashboard"></i> Home</strong></a></li>
        <li class="active"><strong>Fuel Type Register</strong></li>
		 <li class="active"><strong>Fuel Type List</strong></li>
</ol>
</section>
<br>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="main_bod">
  ...
  <tbody>
	...
	<?php
	  $fsql = "select * from fuel_type_master order by ftm_type asc" ;
	  $frec = q($fsql);
	  $i = 1;
	  while($fres = f($frec))
	  {
    ...
    <tr align="center" <?php echo $col;?>>
      ...
      <td><?php echo $fres['ftm_type'];?></td>
      <td><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
		  	<a href="fuel_type_register.php?Edit=<?php echo @$fres['ftm_id'];?>">
