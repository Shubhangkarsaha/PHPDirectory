...
<br>
  <table width="70%" border="0" align="center" cellpadding="1" cellspacing="1" class="main_bod">
    ...
    <tr>
      <td  align="center" <?php if($_SESSION['user_type'] != 'A'){echo "width=50%";}else{echo "width=36%";}?>>
		...
		<td align="center" <?php if($_SESSION['user_type'] != 'A'){echo "width=50%";}else{echo "width=30%";}?>>
