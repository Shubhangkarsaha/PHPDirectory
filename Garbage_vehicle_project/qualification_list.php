...
<section class="content-header">
  ...
  <li><a href="dashboard.php"><strong><i class="fa fa-dashboard"></i> Home</strong></a></li>
        <li class="active"><strong>Qualifiaction Register</strong></li>
		 <li class="active"><strong>Qualifiaction List</strong></li>
</ol>
</section>
<br>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="main_bod">
  ...
  <tbody>
    <tr align="center" class="head_font" background="images\1by25.jpg">
      ...
      <td width="37%" height="40"><b>Qualification</b></td>
	...
	<?php
	  $fsql = "select * from qualification_master where qm_status = '1' order by qm_name asc" ;
	  $frec = q($fsql);
	  $i = 1;
	  while($fres = f($frec))
	  {
    ...
    <tr align="center" <?php echo $col;?>>
      ...
      <td><?php echo $fres['qm_name'];?></td>
      <td><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
		  	<a href="qualification_register.php?Edit=<?php echo @$fres['qm_id'];?>">
