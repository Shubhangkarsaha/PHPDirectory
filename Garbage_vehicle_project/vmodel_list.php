...
<section class="content-header">
  ...
  <li><a href="dashboard.php"><strong><i class="fa fa-dashboard"></i> Home</strong></a></li>
        <li class="active"><strong>Vehicle Details Register</strong></li>
		 ...
		 <li class="active"><strong>Model List</strong></li>
</ol>
</section>
<br>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="main_bod">
  ...
  <tbody>
    <tr align="center" class="head_font" background="images\1by25.jpg">
      ...
      <td width="37%">Manufacturer</td>
      <td width="37%" height="40"><b>Model</b></td>
	...
	<?php
	  $fsql = "select * from vehicle_model_master where vmodel_status > '0' order by vmodel_manufacturer asc, vmodel_name asc " ;
	  $frec = q($fsql);
	  $i = 1;
	  while($fres = f($frec))
	  {
    ...
    <tr align="center" <?php echo $col;?>>
      ...
      <td><?php echo vehicle_manufacturer($fres['vmodel_manufacturer']);?></td>
      <td><?php echo $fres['vmodel_name'];?></td>
      <td><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center">
		  	<a href="vmodel_register.php?Edit=<?php echo @$fres['vmodel_id'];?>">
          ...
          <td align="center">
            <!--<input type="image" name="imageField22" src="allicons/70.gif" title="Delete Record" onclick="delet('desig_list.php?Del=<?php //echo @$fres['desig_id'];?>')"/>-->          </td>
        </tr>
